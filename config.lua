...
Config.Registers = {
    ...
    [33] = {vector3(812.87, -783.21, 26.17), robbed = false, time = 0, safeKey = 20, camId = 31},
    [34] = {vector3(812.74, -781.14, 26.17), robbed = false, time = 0, safeKey = 20, camId = 31},
}
...
Config.Safes = {
    ...
    [5] = {vector3(31.19, -1339.27, 29.5), type = "keypad", robbed = false, camId = 8},
    ...
    [11] = {vector3(-3048.67, 588.48, 7.91), type = "keypad", robbed = false, camId = 14},
    [12] = {vector3(-3249.67, 1007.45, 12.83), type = "keypad", robbed = false, camId = 15},
    [13] = {vector3(543.74, 2662.65, 42.16), type = "keypad", robbed = false, camId = 16},
    [14] = {vector3(1169.31, 2717.79, 37.15), type = "padlock", robbed = false, camId = 17},
    [15] = {vector3(2674.34, 3289.23, 55.24), type = "keypad", robbed = false, camId = 18},
    [16] = {vector3(1961.79, 3750.23, 32.34), type = "keypad", robbed = false, camId = 19},
    [17] = {vector3(1737.45, 6419.46, 35.04), type = "keypad", robbed = false, camId = 20},
    [18] = {vector3(-168.40, 6318.80, 30.58), type = "padlock", robbed = false, camId = 27},
    [19] = {vector3(170.96, 6642.44, 31.7), type = "keypad", robbed = false, camId = 30},
    [20] = {vector3(819.18, -774.57, 26.18), type = "padlock", robbed = false, camId = 31},
}
